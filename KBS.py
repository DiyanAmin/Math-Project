...
def startGame():
    ...
    def Once():
        answer=0
        questionNumber=questionNumberStorage+1
        ...
        if questionType=='Addition':
            ...
            questionLabel=ctk.CTkLabel(r,text=f'Q-{questionNumber}. {question}',font=questionFont)
